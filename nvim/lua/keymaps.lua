...
vim.api.nvim_set_keymap("n", "<Leader>ffs", "<cmd>lua vim.lsp.buf.formatting_sync()<CR>", opts)
vim.api.nvim_set_keymap("n", "<Leader>ffsw", "<cmd>lua vim.lsp.buf.formatting_sync()<CR>:w<CR>", opts)
